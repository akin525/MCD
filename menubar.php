...
?>
                ...
                <li><a  href="paytv.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">Pay Tv</span>
                    </a>
                </li>
                <li><a  href="paybill.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">Pay Bills</span>
                    </a>
                </li>
                <li><a  href="myinvoice.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">My Invoice</span>
                    </a>
                </li>
                <li><a  href="fundwallet.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">Fund Wallet</span>
                    </a>
                </li>
                <li><a  href="pop.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
