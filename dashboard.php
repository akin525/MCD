...
?>
<?php
$query="SELECT  sum(amount) FROM bill_payment where username ='".$_SESSION['username']."'";
...
<!--                            </svg>-->
                        ...
                        <div>
                            ...
                            ?>
                            <button type="button" class="btn btn-success"><a href="fundwallet.php" >Fund Wallet</a>----NGN<?php echo number_format(intval($balance *1),2);?></button>
                            <?php }?>
...
<!--                            </svg>-->
                        ...
                        <div>
                            <h2 class="text-white invoice-num"></h2>
                            <button type="button" class="btn btn-success"><span class="text-white invoice-num"> <a href="Buyairtime.php">Buy MCD Mobile Airtime</a></span></button>
...
<!--                            </svg>-->
                        ...
                        <div>
                            <h2 class="text-white invoice-num"></h2>
                            <button type="button" class="btn btn-info"><span class="text-white invoice-num"><a href="buydata.php">Buy MCD Mobile Data</a></span></button>
                            <span class="text-white fs-18"></span>
                        </div>
                    </div>
                </div>
...
<!--                            </svg>-->
                        ...
                        <div>
                            <h2 class="text-white invoice-num"></h2>
                            <button type="button" class="btn btn-secondary"><h4 class="text-white invoice-num"><a href="paytv.php">Pay Tv</a></h4></button>
                            <span class="text-white fs-18"></span>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card-bx bg-blue">
                                    ...
                                    <div class="card-info text-white">
                                        ...
                                        <h2 class="text-white card-balance">NGN.<?php echo number_format(intval($sp *1),2);?></h2>
                                        <p class="fs-16">Total Bill Spent</p>
