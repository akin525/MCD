            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card  invoice-card">
                    <div class="d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">NGN <?php echo number_format(intval($balance *1),2);?></h2>
                            <button type="button" class="btn btn-success"> <a href="fundwallet.php" >Fund Wallet</a></button>
                            <p></p>
